  ...
  Widget build(BuildContext context) {
    return DecoratedBox(
      ...
      decoration: const BoxDecoration(
        // color: Colors.blueAccent,"C:\Project\GSCWD\map_studio\assets\images\bg_portrait.png"
        image: DecorationImage(
          image: AssetImage("assets/images/bg_portrait.png"),
          fit: BoxFit.cover,
        ),
      ),
      child: Stack(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: DefaultText(
                        text: 'Successful', txtSize: 26, color: Colors.white),
                  ),
                  Padding(
